...
export const LESSON_CATEGORIES = [
  {
    ...
    lessons: [
      { id: 'smash_home_1', title: 'Home Row Anchor', focus: 'asdf jkl;', type: 'letters', minWpm: 5,
        patterns: ['ff dd ss aa jj kk ll ;;', 'asdf jkl; fdsa lkj; jk;l', 'f j d k s l a ; fjdksla;'] },
      { id: 'smash_home_2', title: 'Home Row Alternation', focus: 'Index & middle fingers', type: 'letters', minWpm: 6,
        patterns: ['fjf dkd sls a;a jfj kdk lsl ;a;', 'ff jj dd kk ss ll aa ;;', 'fad s;l fks djla fjad ks;l'] },
      { id: 'smash_home_3', title: 'The Wrench Handle', focus: 'Including G & H', type: 'letters', minWpm: 7,
