...
const VERSION = 'mtt-v8';
const SHELL = [
  '.', 'index.html', 'manifest.webmanifest',
  'styles/app.css',
  'js/main.js', 'js/ui.js', 'js/lessons.js', 'js/audio.js', 'js/music.js', 'js/wavetable.js', 'js/chiptune.js', 'js/finger.js',
  'js/keyboard.js', 'js/sprite.js', 'js/sprite-frames.js', 'js/hero-sprite.js', 'js/tiles.js', 'js/engine.js', 'js/ghost.js',
  'js/modes/focus.js', 'js/modes/scroller.js', 'js/modes/hero.js', 'js/modes/guitar.js',
  'vendor/three.module.min.js', 'vendor/soundfont-player.min.js',
  'assets/sprites/mansfield.png', 'assets/sprites/mansfield-shadow.png', 'assets/sprites/typing-hero.png', 'assets/sprites/tiles.png',
