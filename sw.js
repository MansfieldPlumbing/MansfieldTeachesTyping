...
const VERSION = 'mtt-v7';
const SHELL = [
  '.', 'index.html', 'manifest.webmanifest',
  'styles/app.css',
  'js/main.js', 'js/ui.js', 'js/lessons.js', 'js/audio.js', 'js/music.js', 'js/wavetable.js', 'js/chiptune.js', 'js/finger.js',
  'js/keyboard.js', 'js/sprite.js', 'js/sprite-frames.js', 'js/hero-sprite.js', 'js/engine.js', 'js/ghost.js',
  ...
  'assets/sprites/mansfield.png', 'assets/sprites/mansfield-shadow.png', 'assets/sprites/typing-hero.png',
